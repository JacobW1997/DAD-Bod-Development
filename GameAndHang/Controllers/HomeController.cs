...
namespace GameAndHang.Controllers
{
    public class HomeController : Controller
    {
        ...
        {           
            ...
            string URL = "https://www.boardgameatlas.com/api/search?order_by=popularity&limit=20&client_id=" + System.Web.Configuration.WebConfigurationManager.AppSettings["AtlasKey"];
            Debug.WriteLine(URL);
